        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-morris')) }}">الفزاتير المدفوعة</a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-morris')) }}">الفواتير الغير
                            مدفوعة</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-morris')) }}">الفواتير المدفوعة
                            جزئيا</a></li>
                </ul>
            </li>
